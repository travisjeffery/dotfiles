...
;;   Journal of Functional Programming, Vol 8, no 5, p 493-502, 1998.
;;   
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defun haskell-indent-def-key-menu (command key menu-label)
  "Assign COMMAND to a KEY and to the menu haskell-indent-menu-map
labelled with MENU-LABEL"
  (local-set-key key    command)
  (define-key haskell-indent-menu-map (vector command)
    (cons menu-label command)) 
)
...
(defun turn-on-haskell-indent ()
  ...
  (haskell-indent-def-key-menu 'haskell-indent-cycle "\t" "Indent cycle")
  (haskell-indent-def-key-menu
   'haskell-indent-insert-equal "\C-c=" "Insert equal")
  (haskell-indent-def-key-menu
   'haskell-indent-insert-guard "\C-c|" "Insert guard")
  (haskell-indent-def-key-menu
   'haskell-indent-insert-otherwise "\C-co" "Insert otherwise")
  (haskell-indent-def-key-menu
   'haskell-indent-insert-where "\C-cw" "Insert where")
  (haskell-indent-def-key-menu
   'haskell-indent-align-guards-and-rhs "\C-c." "Align guards and rhs")
  (haskell-indent-def-key-menu
   'haskell-indent-put-region-in-literate "\C-c>" "Region in lit")
  (setq haskell-indent-mode t)
  (define-key haskell-mode-map [menu-bar haskell]
    (cons "Haskell" haskell-indent-menu-map))
  (run-hooks 'haskell-indent-hook)
  )

(defun haskell-indent-undef-key-menu (command key)
  "De-assign COMMAND to a KEY and to the menu haskell-indent-menu-map"
  (local-unset-key key)
  (define-key haskell-indent-menu-map (vector command) nil) 
)
...
the layout rule of Haskell.  "
  ...
  (local-unset-key "\177")
  (haskell-indent-undef-key-menu 'haskell-indent-cycle "\t")
  (haskell-indent-undef-key-menu 'haskell-indent-insert-equal "\C-c=")
  (haskell-indent-undef-key-menu 'haskell-indent-insert-guard "\C-c|")
  (haskell-indent-undef-key-menu 'haskell-indent-insert-otherwise "\C-co")
  (haskell-indent-undef-key-menu 'haskell-indent-insert-where "\C-cw")
  (haskell-indent-undef-key-menu 'haskell-indent-align-guards-and-rhs "\C-c.")
  (haskell-indent-undef-key-menu 'haskell-indent-put-region-in-literate "\C-c>")
...
;;  items of this menu can also be set by "haskell-hugs.el" 
(defvar haskell-indent-menu-map nil)
(if haskell-indent-menu-map nil
  (setq haskell-indent-menu-map (make-sparse-keymap "Haskell-indent")))
